...
selected Labeloo sync service. Passwords are transmitted over encrypted HTTPS
in production and stored only as password hashes. Signing out keeps the local
copy. Users can delete cloud projects, revoke API keys, or delete an account.
...
Labeloo does not collect browsing history, run advertising, or use project
content for behavioral advertising. We do not sell address lists or synced
project content.

The complete hosted policy is available at
<https://labs.wiplash.ai/labeloo/privacy/>. Privacy requests may be sent to
support@wiplash.ai.
